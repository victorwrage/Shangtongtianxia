package com.zdv.shangtongtianxia.util.search.Utilities;
...
public class InitiateSearch {
    ...
    public static void handleToolBar(final Context context, final LinearLayout search, final ListView listView, final EditText editText) {
