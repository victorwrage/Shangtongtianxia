...
public class DragFloatActionButton extends FloatingActionButton {
    ...
    private void init() {
        screenWidth = Utils.getInstance().getScreenWidth(getContext());
        screenWidthHalf = screenWidth / 2;
        screenHeight =  Utils.getInstance().getScreenHeight(getContext());
        statusHeight =  Utils.getInstance().getStatusHeight(getContext());
        virtualHeight= Utils.getInstance().getVirtualBarHeigh(getContext());
    }
    private int lastX;
    private int lastY;
