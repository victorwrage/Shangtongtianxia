...
-keep class com.google.gson.stream.** { *; }
-keep class com.zdv.shangtongtianxia.bean.**{*;}#这是你定义的实体类
-keep class com.zdv.shangtongtianxia.RenRenSongContentInfo{*;}#这是你定义的实体类
-keep class com.zdv.shangtongtianxia.RenRenSongEvaluateInfo{*;}#这是你定义的实体类
